import '../filter_screen/widgets/foodfilterbutto_item_widget.dart';
import '../filter_screen/widgets/locationfilter_item_widget.dart';
import '../filter_screen/widgets/typefiltebutton_item_widget.dart';
    ...
    return SafeArea(
      child: Scaffold(
                            ...
                            () => Wrap(
                              ...
                              children: List<Widget>.generate(
                                controller.filterModelObj.value
                                    .typefiltebuttonItemList.value.length,
                                (index) {
                                  TypefiltebuttonItemModel model = controller
                                      .filterModelObj
                                      .value
                                      .typefiltebuttonItemList
                                      .value[index];

                                  return TypefiltebuttonItemWidget(
                                    model,
                                  );
                                },
                              ),
                        ...
                        child: Padding(
                          ...
                          child: Obx(
                            () => Wrap(
                              ...
                              children: List<Widget>.generate(
                                controller.filterModelObj.value
                                    .locationfilterItemList.value.length,
                                (index) {
                                  LocationfilterItemModel model = controller
                                      .filterModelObj
                                      .value
                                      .locationfilterItemList
                                      .value[index];

                                  return LocationfilterItemWidget(
                                    model,
                                  );
                                },
                              ),
              ...
              Padding(
                ...
                child: Obx(
                  () => Wrap(
                    ...
                    spacing: 10.h,
                    children: List<Widget>.generate(
                      controller.filterModelObj.value.foodfilterbuttoItemList
                          .value.length,
                      (index) {
                        FoodfilterbuttoItemModel model = controller
                            .filterModelObj
                            .value
                            .foodfilterbuttoItemList
                            .value[index];

                        return FoodfilterbuttoItemWidget(
                          model,
                        );
                      },
                    ),
        ...
        bottomNavigationBar: CustomElevatedButton(
          ...
          buttonTextStyle: CustomTextStyles.bodyMediumBentonSansBoldWhiteA70001,
        ),
      ),
    );
  }
