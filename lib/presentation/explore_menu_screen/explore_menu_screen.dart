import '../explore_menu_screen/widgets/menuitem_item_widget.dart';
...
class ExploreMenuScreen extends GetWidget<ExploreMenuController> {
  const ExploreMenuScreen({Key? key})
      : super(
          key: key,
        );
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.exploreMenuModelObj.value
                          .menuitemItemList.value.length,
                      itemBuilder: (context, index) {
                        MenuitemItemModel model = controller.exploreMenuModelObj
                            .value.menuitemItemList.value[index];
                        return MenuitemItemWidget(
                          model,
                        );
                      },
                    ),
