import '../voucher_promo_screen/widgets/specialdeal_item_widget.dart';
...
class VoucherPromoScreen extends GetWidget<VoucherPromoController> {
                      ...
                      child: SizedBox(
                          ...
                          child: Stack(alignment: Alignment.topLeft, children: [
                            ...
                            Align(
                                ...
                                child: Padding(
                                    padding:
                                        EdgeInsets.only(left: 2.h, top: 102.v),
                                    child: Text("lbl_voucher_promo".tr,
                  ...
                  Expanded(
                      child: Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.voucherPromoModelObj.value
                                  .specialdealItemList.value.length,
                              itemBuilder: (context, index) {
                                SpecialdealItemModel model = controller
                                    .voucherPromoModelObj
                                    .value
                                    .specialdealItemList
                                    .value[index];
                                return SpecialdealItemWidget(model);
                              }))))
                ])),
            bottomNavigationBar: CustomElevatedButton(
                text: "lbl_check_out".tr,
                margin: EdgeInsets.only(left: 26.h, right: 25.h, bottom: 33.v),
