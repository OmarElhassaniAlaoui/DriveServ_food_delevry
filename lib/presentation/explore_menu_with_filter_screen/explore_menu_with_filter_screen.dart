import '../explore_menu_with_filter_screen/widgets/menuitem1_item_widget.dart';
...
class ExploreMenuWithFilterScreen
  ...
  const ExploreMenuWithFilterScreen({Key? key})
      : super(
          key: key,
        );
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              CustomTextFormField(
                                width: 92.h,
                                controller: controller.filteroneController,
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.exploreMenuWithFilterModelObj.value
                          .menuitem1ItemList.value.length,
