import '../your_orders_screen/widgets/menuitem3_item_widget.dart';
...
class YourOrdersScreen extends GetWidget<YourOrdersController> {
  const YourOrdersScreen({Key? key})
      : super(
          key: key,
        );
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.yourOrdersModelObj.value
                          .menuitem3ItemList.value.length,
                      itemBuilder: (context, index) {
                        Menuitem3ItemModel model = controller.yourOrdersModelObj
                            .value.menuitem3ItemList.value[index];
                        return Menuitem3ItemWidget(
                          model,
                        );
                      },
                    ),
