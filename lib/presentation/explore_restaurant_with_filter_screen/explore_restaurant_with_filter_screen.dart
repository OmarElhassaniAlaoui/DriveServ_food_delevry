import '../explore_restaurant_with_filter_screen/widgets/restaurantprofi1_item_widget.dart';
...
class ExploreRestaurantWithFilterScreen
  ...
  const ExploreRestaurantWithFilterScreen({Key? key})
      : super(
          key: key,
        );
                              ...
                              Obx(
                                () => CustomRadioButton(
                                  ...
                                  textStyle: CustomTextStyles
                                      .bodySmallBentonSansMediumDeeporange700,
                                  isRightCheck: true,
                                  onChange: (value) {
                              ...
                              Container(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    CustomImageView(
                                      svgPath:
                                          ImageConstant.imgCloseDeepOrange700,
                                      height: 18.adaptSize,
                                      width: 18.adaptSize,
                                      alignment: Alignment.bottomRight,
                                      margin: EdgeInsets.only(
                                    ...
                                    CustomTextFormField(
                                      width: 92.h,
                                      controller: controller.drinkoneController,
                    ...
                    child: Obx(
                      () => GridView.builder(
                        ...
                        itemCount: controller
                            .exploreRestaurantWithFilterModelObj
                            .value
                            .restaurantprofi1ItemList
                            .value
                            .length,
                        itemBuilder: (context, index) {
                          Restaurantprofi1ItemModel model = controller
                              .exploreRestaurantWithFilterModelObj
                              .value
                              .restaurantprofi1ItemList
                              .value[index];
                          return Restaurantprofi1ItemWidget(
                            model,
                          );
                        },
                      ),
