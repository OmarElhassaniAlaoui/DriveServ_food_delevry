import '../upload_photo_screen/widgets/gallerybutton_item_widget.dart';
                  ...
                  Expanded(
                      child: Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.uploadPhotoModelObj.value
                                  .gallerybuttonItemList.value.length,
                              itemBuilder: (context, index) {
                                GallerybuttonItemModel model = controller
                                    .uploadPhotoModelObj
                                    .value
                                    .gallerybuttonItemList
                                    .value[index];
                                return GallerybuttonItemWidget(model);
                              }))))
                ])),
