import '../via_method_screen/widgets/usersignal_item_widget.dart';
...
class ViaMethodScreen extends GetWidget<ViaMethodController> {
                  ...
                  Expanded(
                      child: Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.viaMethodModelObj.value
                                  .usersignalItemList.value.length,
                              itemBuilder: (context, index) {
                                UsersignalItemModel model = controller
                                    .viaMethodModelObj
                                    .value
                                    .usersignalItemList
                                    .value[index];
                                return UsersignalItemWidget(model);
                              }))))
                ])),
