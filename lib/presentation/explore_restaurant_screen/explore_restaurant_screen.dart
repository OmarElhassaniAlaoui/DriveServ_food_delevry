import '../explore_restaurant_screen/widgets/restaurantprofi_item_widget.dart';
...
class ExploreRestaurantScreen extends GetWidget<ExploreRestaurantController> {
  const ExploreRestaurantScreen({Key? key})
      : super(
          key: key,
        );
                  ...
                  child: Padding(
                    ...
                    child: Obx(
                      () => GridView.builder(
                        ...
                        itemCount: controller.exploreRestaurantModelObj.value
                            .restaurantprofiItemList.value.length,
                        itemBuilder: (context, index) {
                          RestaurantprofiItemModel model = controller
                              .exploreRestaurantModelObj
                              .value
                              .restaurantprofiItemList
                              .value[index];
                          return RestaurantprofiItemWidget(
                            model,
                          );
                        },
                      ),
